...
print Matrix "   u = uu[2];\n";
print Matrix "#elif DIM == 2\n";
print Matrix "   u = uu[2];\n";
print Matrix "   v = uu[3];\n";
print Matrix "#elif DIM == 3 || DIM == 4\n";
print Matrix "   u = uu[2];\n";
print Matrix "   v = uu[3];\n";
print Matrix "   w = uu[4];\n";
print Matrix "#endif\n";
...
print Matrix "#endif\n";
print Matrix "\n";
print Matrix "   a[0] = $a[0]";
print Matrix "   a[1] = $a[1]";
print Matrix "   a[2] = $a[2]";
print Matrix "     \n";
print Matrix "   return 0;\n";                                       
print Matrix "}\n";                                                 
close(Matrix);
...
print Matrix "   a[1] = $a[1]";
print Matrix "   a[2] = $a[2]";
print Matrix "   a[3] = $a[3]";
print Matrix "   a[4] = $a[4]";
print Matrix "\n";
print Matrix "   return 0;\n";                                       
print Matrix "}\n";                                                 
close(Matrix);
